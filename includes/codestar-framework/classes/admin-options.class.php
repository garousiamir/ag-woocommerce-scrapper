...
if ( ! class_exists( 'CSF_Options' ) ) {
  class CSF_Options extends CSF_Abstract {
    ...
    public $args         = array(
      ...
      // framework title
      'framework_title'         => 'تنظیمات اسکراپر',
      'framework_class'         => '',
      ...
      // footer
      'footer_text'             => 'طراحی شده توسط امیرحسین گروسی',
      'footer_after'            => '',
      'footer_credit'           => '',
      ...
      echo '<div class="csf csf-options'. esc_attr( $theme . $class . $wrapper_class ) .'" data-slug="'. esc_attr( $this->args['menu_slug'] ) .'" data-unique="'. esc_attr( $this->unique ) .'">';
        ...
        echo '<div class="csf-header-inner">';
          ...
          echo '<div class="csf-header-right">';
            ...
            echo '<input type="submit" name="'. esc_attr( $this->unique ) .'[_nonce][save]" class="button button-primary csf-top-save csf-save'. esc_attr( $ajax_class ) .'" value="'. esc_html__( 'ذخیره', 'csf' ) .'" data-save="'. esc_html__( 'Saving...', 'csf' ) .'">';
